...
.mobileNavIcon svg{width:20px;height:20px;display:block}
  ...
  .channelsHero{padding:22px 20px;border-radius:20px}.channelsHero h3{font-size:25px}.channelConnectCard{grid-template-columns:48px 1fr;padding:16px}.channelConnectIcon{width:48px;height:48px;border-radius:14px}.channelConnectActions{grid-column:1/-1;justify-content:stretch;max-width:none}.channelConnectActions .primaryBtn,.channelConnectActions .ghostBtn,.channelAssetSelect{flex:1;max-width:none}
      ...
      ${channelConnectionsV1Enabled ? `<section class="${viewClass('panel-channels')}" id="panel-channels">
        <div class="channelsView">
          <section class="channelsHero">
            ...
            <p>Empieza con WhatsApp. Si también atiendes mensajes por Instagram, puedes conectarlo después. NextforIA nunca te pedirá tokens, claves ni credenciales técnicas.</p>
          </section>
