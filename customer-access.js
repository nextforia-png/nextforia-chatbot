...
<body>
  ...
  ${valid ? `<script>
    ...
    function errorMessage(code){return {invalid_request:"Revisa la información e intenta de nuevo.",weak_password:"Usa entre 12 y 128 caracteres, con al menos una letra y un número.",password_mismatch:"Las contraseñas no coinciden.",invalid_invitation:"Esta invitación no es válida.",invitation_expired:"Esta invitación venció. Solicita una nueva a Nextfor IA.",invitation_revoked:"Esta invitación fue revocada. Solicita una nueva a Nextfor IA.",invitation_already_used:"Esta invitación ya fue utilizada. Ingresa con tu correo y contraseña.",invalid_credentials:"Ese acceso ya existe. Usa la contraseña que creaste o ingresa desde el login.",customer_access_unavailable:"No pudimos validar tu acceso en este momento. Intenta de nuevo más tarde."}[code]||"No pudimos crear el acceso. Intenta de nuevo.";}
