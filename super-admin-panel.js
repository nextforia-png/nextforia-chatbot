...
function logoutSuperAdmin(){try{["rav_dashboard_key","rav_dashboard_tab","rav_logo","nextfor-integration-result"].forEach(function(key){localStorage.removeItem(key);});}catch(e){}try{["nextforia_tenant_id","tenant_id","rav_tenant_id"].forEach(function(key){sessionStorage.removeItem(key);});}catch(e){}fetch("/admin/logout",{method:"POST"}).finally(function(){location.href="/admin";});}
