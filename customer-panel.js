...
@media(max-width:760px){
  ...
  .notificationsView,#panel-notifications,.notificationEmailSettings,.notificationEmailIntro,.notificationEmailHeadCopy,.notificationEmailActions,.notificationEmailStatus{min-width:0;max-width:100%}.notificationControls{grid-template-columns:40px minmax(0,1fr);align-items:center;padding:14px}.notificationControlsIcon{width:40px;height:40px}.notificationControls .primaryBtn{grid-column:1/-1;width:100%}.notificationEmailSettings{gap:15px;padding:15px;border-radius:18px}.notificationEmailIntro{grid-template-columns:42px minmax(0,1fr);align-items:start;gap:11px}.notificationEmailIcon{width:42px;height:42px;border-radius:13px}.notificationEmailHeadCopy>strong{font-size:15px}.notificationEmailHeadCopy>span{font-size:11.5px}.notificationEmailSwitch{grid-column:1/-1;width:100%;min-width:0;box-sizing:border-box}.notificationEmailSwitchCopy strong{white-space:normal}.notificationEmailRecipient{width:100%;min-width:0;box-sizing:border-box}.notificationEmailTypes{width:100%;grid-template-columns:minmax(0,1fr)}.notificationEmailType{width:100%;min-width:0;min-height:60px}.notificationEmailActions{align-items:stretch;flex-direction:column}.notificationEmailActions .primaryBtn{width:100%;min-width:0}.notificationEmailStatus{width:100%;overflow-wrap:anywhere}.handoffToast{right:16px;top:16px;grid-template-columns:42px 1fr}.handoffToast button{grid-column:1/-1;width:100%}
      ...
      <section class="${viewClass('panel-notifications')}" id="panel-notifications">
        <div class="notificationsView">
          ...
          <section class="notificationEmailSettings" id="notificationEmailSettings" hidden>
            <div class="notificationEmailIntro">
              ...
              <div class="notificationEmailHeadCopy"><small class="notificationEmailEyebrow">Nextfor vigila por ti</small><strong>No dejes pasar lo que mueve tu negocio</strong><span>Elige los momentos importantes y te avisaremos para que puedas actuar a tiempo.</span></div>
