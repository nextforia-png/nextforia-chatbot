...
<body${panelRedesignEnabled && ["summary", "conversations", "orders", "retargeting"].includes(initialTab) ? ' class="panel-redesign"' : ""}>
<div class="app">
...
function showTab(name){
  ...
  state.tab=name;
  document.body.classList.toggle("panel-redesign",PANEL_REDESIGN_ENABLED&&["summary","conversations","orders","retargeting"].includes(name));
