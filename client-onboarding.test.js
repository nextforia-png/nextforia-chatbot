...
const duplicatedBothAnswers = cloneDefaults();
duplicatedBothAnswers.setup_goal = "both";
duplicatedBothAnswers.business.brand_name = "Nombre compartido";
duplicatedBothAnswers.business.contact_email = "contacto@compartido.example";
duplicatedBothAnswers.operations.support_hours = "Lunes a viernes de 8 a 5";
duplicatedBothAnswers.customer_service_setup.business_offer_description = "Spa y peluquería para mascotas";
duplicatedBothAnswers.customer_service_setup.ideal_customer = "Familias con mascotas";
duplicatedBothAnswers.customer_service_setup.value_proposition = "Atención cuidadosa";
duplicatedBothAnswers.customer_service_setup.bot_display_name = "Lumen de Mascotas";
duplicatedBothAnswers.customer_service_setup.tone = "calido_empatico";
duplicatedBothAnswers.appointment_setup.business_name = "Nombre viejo";
duplicatedBothAnswers.appointment_setup.business_description = "Descripción vieja";
duplicatedBothAnswers.appointment_setup.assistant_tone = "formal_corporativo";
const normalizedBothAnswers = normalizeOnboarding(duplicatedBothAnswers);
assert.strictEqual(normalizedBothAnswers.appointment_setup.business_name, "Nombre compartido");
assert.strictEqual(normalizedBothAnswers.appointment_setup.business_description, "Spa y peluquería para mascotas");
assert.strictEqual(normalizedBothAnswers.appointment_setup.target_customer, "Familias con mascotas");
assert.strictEqual(normalizedBothAnswers.appointment_setup.business_differentiator, "Atención cuidadosa");
assert.strictEqual(normalizedBothAnswers.appointment_setup.bot_display_name, "Lumen de Mascotas");
assert.strictEqual(normalizedBothAnswers.appointment_setup.assistant_tone, "calido_empatico");
assert.strictEqual(normalizedBothAnswers.appointment_setup.escalation_contact, "");
assert.strictEqual(normalizedBothAnswers.appointment_setup.human_support_hours, "Lunes a viernes de 8 a 5");
assert.strictEqual(normalizedBothAnswers.appointment_setup.channel_email, "contacto@compartido.example");
assert.strictEqual(normalizedBothAnswers.operations.services_products, "Spa y peluquería para mascotas");
