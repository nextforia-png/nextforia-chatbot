...
.ai-cost-controls{display:flex;align-items:center;gap:8px;flex-wrap:wrap}
.ai-cost-controls select{height:38px;border:1.5px solid var(--border-default);border-radius:var(--radius-md);padding:0 10px;background:#fff;color:var(--text-strong);font:700 11px var(--font-body)}
.ai-overview-card{overflow:hidden;border-color:var(--cyan-100);background:linear-gradient(135deg,#F4FBFF 0%,#fff 58%)}
.ai-overview-main{display:grid;grid-template-columns:minmax(0,1.35fr) minmax(240px,.65fr);gap:18px;padding:4px 0 18px}
.ai-overview-total{padding:4px 2px}.ai-overview-total>span{display:block;color:var(--text-muted);font-size:11px;font-weight:800}.ai-overview-total>strong{display:block;margin-top:7px;color:var(--navy-900);font:800 36px/1 var(--font-display);letter-spacing:-.04em}.ai-overview-total>p{max-width:700px;margin:11px 0 0;color:var(--text-body);font-size:12px;line-height:1.6}
.ai-overview-status{padding:15px 16px;border:1px solid var(--cyan-100);border-radius:15px;background:#fff}.ai-overview-status strong{display:block;margin-top:10px;color:var(--text-strong);font:800 15px var(--font-display)}.ai-overview-status p{margin:5px 0 0;color:var(--text-muted);font-size:10.5px;line-height:1.5}
.ai-simple-kpis{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;padding-top:16px;border-top:1px solid var(--cyan-100)}.ai-simple-kpi{padding:12px 13px;border:1px solid var(--border-subtle);border-radius:12px;background:#fff}.ai-simple-kpi span{display:block;color:var(--text-muted);font-size:9.5px}.ai-simple-kpi strong{display:block;margin-top:4px;color:var(--text-strong);font:800 13px var(--font-display)}.ai-simple-kpi small{display:block;margin-top:3px;color:var(--text-subtle);font-size:9px;line-height:1.4}
.ai-provider-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}
.ai-provider-card{display:grid;gap:14px}
.ai-provider-title{display:flex;align-items:center;justify-content:space-between;gap:10px}
.ai-provider-title h2{margin:0;font:700 17px var(--font-display);color:var(--text-strong)}
.ai-cost-metrics{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:9px}
.ai-cost-metric{padding:11px;border:1px solid var(--border-subtle);border-radius:12px;background:var(--slate-50)}
.ai-cost-metric span{display:block;color:var(--text-muted);font-size:10px}
.ai-cost-metric strong{display:block;color:var(--text-strong);font:800 16px var(--font-display);margin-top:4px}
.ai-cost-metric small{display:block;color:var(--text-subtle);font-size:9.5px;margin-top:3px;line-height:1.4}
.ai-provider-actions{display:flex;gap:8px;flex-wrap:wrap}
.ai-provider-summary{margin:-4px 0 0;color:var(--text-muted);font-size:10.5px;line-height:1.5}
.ai-detail-empty{padding:26px 20px;border:1px dashed var(--border-default);border-radius:15px;background:var(--slate-50);text-align:center}.ai-detail-empty strong{display:block;color:var(--text-strong);font:800 15px var(--font-display)}.ai-detail-empty p{max-width:640px;margin:7px auto 0;color:var(--text-muted);font-size:11px;line-height:1.6}
.ai-cost-table-head,.ai-cost-row{display:grid;grid-template-columns:minmax(145px,1.2fr) minmax(115px,.8fr) minmax(90px,.65fr) minmax(100px,.75fr) minmax(95px,.65fr);gap:12px;align-items:center;min-width:680px}
.ai-cost-table-head{padding:11px 17px;background:var(--slate-50);border-bottom:1px solid var(--border-subtle);font-size:9px;font-weight:800;letter-spacing:.07em;text-transform:uppercase;color:var(--text-subtle)}
.ai-cost-row{padding:13px 17px;border-bottom:1px solid var(--border-subtle);font-size:11px;color:var(--text-body)}
.ai-cost-row:last-child{border-bottom:0}
.ai-cost-row strong{display:block;color:var(--text-strong);font-size:11.5px}
.ai-cost-row small{display:block;color:var(--text-muted);font-size:9.5px;line-height:1.45;margin-top:2px}
.ai-cost-explanation{display:grid;gap:8px}
.ai-cost-explanation div{padding:10px 12px;border:1px solid var(--border-subtle);border-radius:11px;background:var(--slate-50)}
.ai-cost-explanation strong{display:block;color:var(--text-strong);font-size:11px}
.ai-cost-explanation span{display:block;color:var(--text-muted);font-size:10px;line-height:1.45;margin-top:3px}
@media(max-width:900px){.ai-overview-main{grid-template-columns:1fr}.ai-simple-kpis{grid-template-columns:1fr}.ai-provider-grid{grid-template-columns:1fr}.ai-overview-total>strong{font-size:30px}}
...
@media(max-width:820px){.catalog-row{grid-template-columns:1fr;gap:8px}.catalog-actions{justify-content:flex-start}.form-grid.three{grid-template-columns:1fr}.billing-metrics{grid-template-columns:repeat(2,minmax(0,1fr))}.billing-history-row{grid-template-columns:1fr}.ai-provider-grid{grid-template-columns:1fr}}
...
<section class="view" data-panel="aiCosts"><div class="stack">
  <section class="card ai-overview-card"><div class="card-head"><div><h2>¿Cuánto hemos gastado en inteligencia artificial?</h2><p id="aiCostPeriodNote">Consultando los reportes oficiales…</p></div><div class="ai-cost-controls"><label class="sr-only" for="aiCostDays">Periodo</label><select id="aiCostDays" onchange="loadAiCosts(false)"><option value="7">Últimos 7 días</option><option value="30" selected>Últimos 30 días</option><option value="90">Últimos 90 días</option></select><button class="button" type="button" onclick="loadAiCosts(true)">${icon("refresh", 15)} Actualizar datos</button></div></div><div class="ai-overview-main"><div class="ai-overview-total"><span>Gasto oficial total</span><strong id="aiOfficialTotal">—</strong><p id="aiPlainSummary">Sumaremos Anthropic y OpenAI para darte una respuesta clara.</p></div><div class="ai-overview-status"><span class="badge neutral dot" id="aiOverallStatus">Verificando</span><strong id="aiOverallTitle">Comprobando proveedores</strong><p id="aiOverallHelp">Validamos conexión, facturación y bloqueos por saldo.</p></div></div><div class="ai-simple-kpis"><div class="ai-simple-kpi"><span>Proveedor con mayor gasto</span><strong id="aiTopProvider">—</strong><small id="aiTopProviderHelp">Calculando participación</small></div><div class="ai-simple-kpi"><span>Proveedores conectados</span><strong id="aiConnectedProviders">—</strong><small>Anthropic y OpenAI</small></div><div class="ai-simple-kpi"><span>Detalle por cliente</span><strong id="aiTrackingStatus">—</strong><small id="aiTrackingHelp">Midiendo actividad nueva</small></div></div></section>
  <div id="aiProviderCards" class="ai-provider-grid"><section class="card"><div class="invite-loading">Cargando Anthropic…</div></section><section class="card"><div class="invite-loading">Cargando OpenAI…</div></section></div>
  <section class="card" id="aiDetailSection"><div class="card-head"><div><h2>¿Qué cliente o bot está consumiendo?</h2><p id="aiTrackingNote">Este detalle se construye con cada conversación nueva.</p></div><span class="badge info" id="aiBotCount">0</span></div><div id="aiDetailEmpty" class="ai-detail-empty"><strong>Aún no hay conversaciones nuevas para comparar</strong><p>El gasto oficial de arriba sí es real. El desglose por cliente comenzó a medirse el 26 de agosto de 2026 y aparecerá automáticamente con la próxima conversación de un bot.</p></div><div id="aiDetailContent" hidden><div class="grid-4"><article class="stat-card"><div class="stat-top"><span>Costo medido</span><span class="icon-chip">${icon("dollar", 17)}</span></div><div class="stat-value" id="aiCostTotal">—</div><div class="stat-sub">solo conversaciones registradas</div></article><article class="stat-card"><div class="stat-top"><span>Llamadas IA</span><span class="icon-chip">${icon("activity", 17)}</span></div><div class="stat-value" id="aiCostCalls">—</div><div class="stat-sub" id="aiCostFailures">Cargando</div></article><article class="stat-card"><div class="stat-top"><span>Tokens de entrada</span><span class="icon-chip">${icon("message", 17)}</span></div><div class="stat-value" id="aiCostInput">—</div><div class="stat-sub" id="aiCostCache">incluye contexto y herramientas</div></article><article class="stat-card"><div class="stat-top"><span>Tokens de salida</span><span class="icon-chip">${icon("bot", 17)}</span></div><div class="stat-value" id="aiCostOutput">—</div><div class="stat-sub">respuestas generadas</div></article></div><section class="table-card" style="margin-top:14px"><div class="list-head"><div><h2>Costo por cliente y bot</h2></div></div><div class="table-scroll"><div class="ai-cost-table-head"><span>Cliente</span><span>Bot</span><span>Llamadas</span><span>Tokens</span><span>Costo estimado</span></div><div id="aiBotRows"></div></div></section><section class="table-card" style="margin-top:14px"><div class="list-head"><div><h2>Conversaciones que más consumen</h2><span class="badge neutral">identidad protegida</span></div></div><div class="table-scroll"><div class="ai-cost-table-head"><span>Conversación</span><span>Cliente / bot</span><span>Llamadas</span><span>Qué consumió</span><span>Costo estimado</span></div><div id="aiConversationRows"></div></div></section><section style="margin-top:14px"><div class="card-head"><div><h2>¿Qué está generando el consumo?</h2><p>Respuestas, audios, imágenes, pruebas y evaluaciones.</p></div></div><div id="aiDriverRows" class="ai-cost-explanation"></div></section></div></section>
</div></section>
...
var aiCostLoading=false,aiCostLoadedDays="";
function aiUsd(value){return value==null||!isFinite(Number(value))?"—":"$"+Number(value).toLocaleString("en-US",{minimumFractionDigits:Number(value)<1?4:2,maximumFractionDigits:Number(value)<1?6:2})+" USD";}
function aiTokens(value){value=Math.max(0,Number(value)||0);return value>=1000000?(value/1000000).toFixed(2)+"M":value>=1000?(value/1000).toFixed(1)+"k":String(Math.round(value));}
function aiDate(value){if(!value)return"Sin actividad en el periodo";var date=new Date(value);return isNaN(date.getTime())?"Sin fecha":date.toLocaleString("es-CO",{dateStyle:"short",timeStyle:"short"});}
function aiProviderLabel(value){return value==="anthropic"?"Anthropic · Claude":"OpenAI";}
function aiBotLabel(value){return({customer_service:"Atención al cliente",appointment:"Agendamiento",multimodal:"Multimodal",platform:"Operación interna"})[value]||value||"Sin bot";}
function aiFeatureLabel(value){return({customer_reply:"Respuesta al cliente",audio_transcription:"Transcripción de audio",image_analysis:"Análisis de imagen",bot_preview:"Prueba del bot",quality_evaluation:"Evaluación de calidad"})[value]||value||"Otra función";}
function aiStatus(value){return({active:["Activo","success"],ready:["Conectado","success"],no_credits:["Recarga necesaria","danger"],missing_key:["Falta conexión","danger"],reporting_credentials_invalid:["Revisar acceso","danger"],not_observed:["Esperando actividad","warning"]})[value]||["Revisar","warning"];}
function aiEmpty(root,message){if(!root)return;root.textContent="";root.appendChild(el("div","invite-loading",message));}
function aiPercent(value,total){return total>0?Math.round((Number(value)||0)/total*1000)/10:0;}
function aiProviderAvailability(provider){if(provider.operational_status==="no_credits")return["Necesita recarga","El proveedor rechazó una llamada por saldo o cuota."];if(provider.operational_status==="missing_key")return["No disponible","Falta conectar la llave usada por los bots."];if(provider.official&&provider.official.status==="error")return["Revisar conexión","No pudimos leer el reporte de facturación."];return["Disponible","No hay bloqueos de saldo detectados."];}
function renderAiProviders(providers,officialTotal){var root=document.getElementById("aiProviderCards");if(!root)return;root.textContent="";(providers||[]).forEach(function(provider){var card=el("section","card ai-provider-card"),head=el("div","ai-provider-title"),title=el("h2",null,aiProviderLabel(provider.provider)),state=aiStatus(provider.operational_status);head.append(title,el("span","badge "+state[1]+" dot",state[0]));card.appendChild(head);var local=provider.local||{},official=provider.official||{},officialConnected=official.status==="connected",availability=aiProviderAvailability(provider),providerCost=officialConnected?Number(official.cost_usd)||0:null,summary=el("p","ai-provider-summary",officialConnected?"Valor facturado por el proveedor durante el periodo seleccionado.":"El reporte oficial todavía no está disponible."),metrics=el("div","ai-cost-metrics");function metric(label,value,help){var item=el("div","ai-cost-metric");item.append(el("span",null,label),el("strong",null,value),el("small",null,help));return item;}card.appendChild(summary);metrics.append(metric("Gastado",officialConnected?aiUsd(providerCost):"No disponible",officialConnected?"dato oficial, no estimado":provider.admin_reporting_configured?"revisa el acceso administrativo":"falta conexión administrativa"),metric("Parte del gasto",officialConnected?aiPercent(providerCost,officialTotal)+"%":"—","comparado con el total de IA"),metric("Estado para operar",availability[0],availability[1]),metric("Detalle por cliente",local.calls?String(local.calls)+" llamadas":"Aún sin datos",local.calls?aiUsd(local.estimated_cost_usd)+" medidos":"aparecerá con actividad nueva"));card.appendChild(metrics);var actions=el("div","ai-provider-actions"),usage=el("a","button","Abrir consumo"),recharge=el("a","button primary","Ver saldo / recargar");usage.href=provider.provider==="anthropic"?"https://platform.claude.com/usage":"https://platform.openai.com/usage";usage.target="_blank";usage.rel="noopener noreferrer";recharge.href=provider.provider==="anthropic"?"https://platform.claude.com/settings/billing":"https://platform.openai.com/settings/organization/billing/overview";recharge.target="_blank";recharge.rel="noopener noreferrer";actions.append(usage,recharge);card.appendChild(actions);root.appendChild(card);});if(!(providers||[]).length)aiEmpty(root,"No hay proveedores configurados.");}
function renderAiBotRows(body){var root=document.getElementById("aiBotRows"),rows=body&&body.usage&&body.usage.bots||[],labels=body.tenant_labels||{};document.getElementById("aiBotCount").textContent=String(rows.length);if(!rows.length){aiEmpty(root,"La telemetría empezará con la siguiente llamada real de un bot.");return;}root.textContent="";rows.forEach(function(row){var line=el("div","ai-cost-row"),tokens=(row.input_tokens||0)+(row.output_tokens||0)+(row.cached_input_tokens||0)+(row.cache_write_tokens||0),client=el("div");client.append(el("strong",null,labels[row.tenant_id]||row.tenant_id),el("small",null,row.tenant_id));var bot=el("div");bot.append(el("strong",null,aiBotLabel(row.bot_id)),el("small",null,(row.successful_calls||0)+" exitosas"));var calls=el("div");calls.append(el("strong",null,String(row.calls||0)),el("small",null,(row.failed_calls||0)+" fallidas"));var token=el("div");token.append(el("strong",null,aiTokens(tokens)),el("small",null,"entrada "+aiTokens(row.input_tokens)+" · salida "+aiTokens(row.output_tokens)));var cost=el("div");cost.append(el("strong",null,aiUsd(row.estimated_cost_usd)),el("small",null,row.unpriced_calls?row.unpriced_calls+" sin tarifa":"tarifa aplicada"));line.append(client,bot,calls,token,cost);root.appendChild(line);});}
function renderAiConversationRows(body){var root=document.getElementById("aiConversationRows"),rows=body&&body.usage&&body.usage.conversations||[],labels=body.tenant_labels||{};if(!rows.length){aiEmpty(root,"Todavía no hay conversaciones medidas en este periodo.");return;}root.textContent="";rows.slice(0,100).forEach(function(row){var line=el("div","ai-cost-row"),conversation=el("div");conversation.append(el("strong",null,row.conversation_ref),el("small",null,(row.channel||"canal")+" · "+aiDate(row.last_success_at||row.last_error_at)));var tenant=el("div");tenant.append(el("strong",null,labels[row.tenant_id]||row.tenant_id),el("small",null,aiBotLabel(row.bot_id)));var calls=el("div");calls.append(el("strong",null,String(row.calls||0)),el("small",null,(row.providers||[]).map(aiProviderLabel).join(" + ")));var use=el("div");use.append(el("strong",null,"Entrada "+aiTokens(row.input_tokens)),el("small",null,"Salida "+aiTokens(row.output_tokens)+" · caché "+aiTokens((row.cached_input_tokens||0)+(row.cache_write_tokens||0))));var cost=el("div");cost.append(el("strong",null,aiUsd(row.estimated_cost_usd)),el("small",null,(row.models||[]).join(", ")));line.append(conversation,tenant,calls,use,cost);root.appendChild(line);});}
function renderAiDrivers(body){var root=document.getElementById("aiDriverRows"),rows=body&&body.usage&&body.usage.drivers||[];if(!rows.length){aiEmpty(root,"Aquí aparecerán respuestas, audios, imágenes, pruebas y evaluaciones.");return;}root.textContent="";rows.forEach(function(row){var item=el("div");item.append(el("strong",null,aiFeatureLabel(row.feature)+" · "+aiUsd(row.estimated_cost_usd)),el("span",null,(row.calls||0)+" llamadas · entrada "+aiTokens(row.input_tokens)+" · salida "+aiTokens(row.output_tokens)+" · caché "+aiTokens((row.cached_input_tokens||0)+(row.cache_write_tokens||0))));root.appendChild(item);});}
function renderAiCosts(body){var totals=body&&body.usage&&body.usage.totals||{},providers=body.providers||[],connected=providers.filter(function(provider){return provider.official&&provider.official.status==="connected";}),officialTotal=body.official_total_usd!=null?Number(body.official_total_usd):connected.reduce(function(sum,provider){return sum+(Number(provider.official.cost_usd)||0);},0),top=connected.slice().sort(function(a,b){return(Number(b.official.cost_usd)||0)-(Number(a.official.cost_usd)||0);})[0],noCredits=providers.filter(function(provider){return provider.operational_status==="no_credits";}),problems=providers.filter(function(provider){return["missing_key","reporting_credentials_invalid"].includes(provider.operational_status)||(provider.official&&provider.official.status==="error");}),days=Number(body.period_days)||30,hasDetail=Number(totals.calls||0)>0,trackingDate=body.tracking_started_at?new Date(body.tracking_started_at).toLocaleDateString("es-CO",{dateStyle:"medium"}):"26 de agosto de 2026",overall=document.getElementById("aiOverallStatus");document.getElementById("aiOfficialTotal").textContent=connected.length?aiUsd(officialTotal):"No disponible";document.getElementById("aiPlainSummary").textContent=connected.length?("En los últimos "+days+" días gastaste "+aiUsd(officialTotal)+". "+(top?aiProviderLabel(top.provider)+" representa "+aiPercent(top.official.cost_usd,officialTotal)+"% del gasto. ":"")+(noCredits.length?"Hay un proveedor que necesita recarga.":"No detectamos bloqueos por saldo.")):"Todavía no podemos leer la facturación oficial. Revisa la conexión de los proveedores.";document.getElementById("aiTopProvider").textContent=top?aiProviderLabel(top.provider):"Sin datos";document.getElementById("aiTopProviderHelp").textContent=top?aiPercent(top.official.cost_usd,officialTotal)+"% del gasto del periodo":"Falta el reporte oficial";document.getElementById("aiConnectedProviders").textContent=connected.length+" de "+providers.length;document.getElementById("aiTrackingStatus").textContent=hasDetail?(totals.calls+" llamadas medidas"):"Esperando actividad";document.getElementById("aiTrackingHelp").textContent=hasDetail?aiUsd(totals.estimated_cost_usd)+" asignados a clientes y bots":"comenzó el "+trackingDate;if(noCredits.length){overall.textContent="Recarga necesaria";overall.className="badge danger dot";document.getElementById("aiOverallTitle").textContent="Un proveedor no puede operar";document.getElementById("aiOverallHelp").textContent="Abre su facturación y realiza una recarga antes de continuar.";}else if(problems.length){overall.textContent="Revisar";overall.className="badge warning dot";document.getElementById("aiOverallTitle").textContent="Hay una conexión incompleta";document.getElementById("aiOverallHelp").textContent="Revisa el proveedor marcado para recuperar su reporte.";}else{overall.textContent="Disponible";overall.className="badge success dot";document.getElementById("aiOverallTitle").textContent="Los proveedores están conectados";document.getElementById("aiOverallHelp").textContent="No hay bloqueos por saldo detectados en las llamadas registradas.";}document.getElementById("aiCostPeriodNote").textContent="Últimos "+days+" días · actualizado "+aiDate(body.generated_at);document.getElementById("aiTrackingNote").textContent="El detalle por cliente empezó el "+trackingDate+"; no inventamos históricos anteriores.";document.getElementById("aiDetailEmpty").hidden=hasDetail;document.getElementById("aiDetailContent").hidden=!hasDetail;document.getElementById("aiCostTotal").textContent=aiUsd(totals.estimated_cost_usd);document.getElementById("aiCostCalls").textContent=String(totals.calls||0);document.getElementById("aiCostFailures").textContent=(totals.failed_calls||0)+" fallidas · "+(totals.no_credit_errors||0)+" por saldo";document.getElementById("aiCostInput").textContent=aiTokens(totals.input_tokens);document.getElementById("aiCostCache").textContent="caché leído/escrito: "+aiTokens((totals.cached_input_tokens||0)+(totals.cache_write_tokens||0));document.getElementById("aiCostOutput").textContent=aiTokens(totals.output_tokens);renderAiProviders(providers,officialTotal);renderAiBotRows(body);renderAiConversationRows(body);renderAiDrivers(body);}
function loadAiCosts(fresh){var days=document.getElementById("aiCostDays")&&document.getElementById("aiCostDays").value||"30";if(aiCostLoading)return Promise.resolve();if(!fresh&&aiCostLoadedDays===days)return Promise.resolve();aiCostLoading=true;document.getElementById("aiCostPeriodNote").textContent="Consultando consumo real…";return fetch("/admin/ai-costs?days="+encodeURIComponent(days)+(fresh?"&fresh=1":""),{headers:{accept:"application/json"}}).then(function(response){return response.json().then(function(body){if(!response.ok)throw new Error(body.error||"ai_costs_unavailable");return body;});}).then(function(body){aiCostLoadedDays=days;renderAiCosts(body);}).catch(function(){document.getElementById("aiCostPeriodNote").textContent="No se pudo cargar el consumo.";aiEmpty(document.getElementById("aiProviderCards"),"Revisa la conexión de telemetría y vuelve a intentar.");showToast("No se pudieron cargar los costos de IA.");}).finally(function(){aiCostLoading=false;});}
...
function renderAppointmentConfigurationVerification(root,verification){if(!root||!verification)return;var section=el("section","setup-channel-summary"),head=el("div","question-toolbar"),title=el("div"),source=verification.persistence==="supabase"?"Supabase":"Memoria de prueba";title.appendChild(el("h2",null,"Confirmación de guardado"));title.appendChild(el("p",null,"Lectura directa del registro central del tenant. No es una copia del navegador."));head.appendChild(title);head.appendChild(el("span","badge "+(verification.sync_status==="failed"?"warning":"success"),verification.sync_status==="failed"?"Requiere atención":"Guardado"));section.appendChild(head);var callout=el("div","callout info-callout");callout.style.marginTop="0";callout.appendChild(el("strong",null,"Backend · "+source+" · revisión "+String(verification.revision||0)));callout.appendChild(el("p",null,"Último guardado: "+(verification.updated_at||"sin fecha")+" · Contexto disponible para Tempo/Atlas: "+(verification.bot_context_ready?"sí":"no")+" · Huella: "+(verification.fingerprint||"—")));section.appendChild(callout);var services=verification.services||[];if(!services.length){section.appendChild(el("p",null,"Aún no hay servicios de citas guardados para este tenant."));root.appendChild(section);return;}var list=el("div","setup-review-history");services.forEach(function(service){var row=el("div"),summary=(service.duration_minutes?service.duration_minutes+" min":"Sin duración")+" · "+(service.modality||"sin modalidad")+(service.deposit_required?" · Con anticipo":"")+" · "+((service.payment_methods||[]).length)+" medio(s) de pago";row.appendChild(el("strong",null,service.name||"Servicio sin nombre"));row.appendChild(el("div",null,service.description||"Sin descripción configurada."));row.appendChild(el("small",null,summary));list.appendChild(row);});section.appendChild(list);root.appendChild(section);}
...
renderAppointmentConfigurationVerification(root,body.configuration_verification);
