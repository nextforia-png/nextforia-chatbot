      ...
      ${channelConnectionsV1Enabled ? `<section class="${viewClass('panel-channels')}" id="panel-channels">
        <div class="channelsView">
          <section class="channelsHero">
            ...
            <p>Ya le enseñaste cómo debe atender. Ahora solo falta decirle dónde recibirá a tus clientes. Empieza con WhatsApp y, si también vendes por Instagram, puedes sumarlo después.</p>
            <div class="metaConnectionSteps" aria-label="Pasos finales con Meta">
              ...
              <article class="metaConnectionStep"><b>2</b><strong>Elige dónde atenderá</strong><span>Selecciona el WhatsApp o Instagram correcto.</span></article>
