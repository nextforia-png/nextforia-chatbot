...
4. **Usuario inicial del tenant:** Customer Access v2 crea una membresía `admin` pendiente por email y la activa mediante una invitación aleatoria, hasheada, revocable, de un solo uso y auditada. El esquema dedicado vive detrás del gate de Staging.
