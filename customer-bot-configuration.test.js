...
assert(configurationUi.clientScript.includes('booking_requirements:draftRequirements,appointment_services:draftServices'));
...
assert(configurationUi.clientScript.includes('Guardando borrador · '));
assert(configurationUi.clientScript.includes('payload.persistence_verified!==true'));
assert(configurationUi.clientScript.includes('Actualizando la versión sin perder tus cambios…'));
assert(configurationUi.clientScript.includes('draftServices=nxClone(state.nxAppointmentServices||[])'));
assert(!configurationUi.clientScript.includes('if(validationError){state.nxAppointmentRequirementsStatus="error"'));
