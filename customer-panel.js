...
<div class="app">
  ...
  <main class="main">
    <header class="topbar">
      ...
      <div class="appointmentTopActions" id="appointmentTopActions" hidden><button class="apptSecondary" type="button" onclick="openAppointmentReprogram()">↻&nbsp; Reprogramar un día</button><div class="avatar">${escapeHtml(panelContext.avatarInitials)}</div></div>
...
try{var initialView=new URL(location.href).searchParams.get("view");if(["agenda","chats","reminders","rules"].includes(initialView))state.appointmentSection=initialView;}catch(e){}
