...
Backlog operativo despues de dejar App Review enviada y produccion en `v60`.
...
- [ ] Hardening del panel.
  - [x] Usuarios/roles en vez de una sola clave compartida.
  - [x] Base futura `super_admin` NexforIA vs `admin` del cliente.
  - [x] Notas internas por cliente.
  - [x] Etiquetas: `venta`, `garantia`, `pendiente_pago`, `envio`, `revisar`.
  - [x] Separar visualmente panel Admin y panel Super admin v1.
  - [ ] Aislar datos, usuarios y configuracion del panel Admin por tenant.
