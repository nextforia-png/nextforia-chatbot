...
function renderConnectionHub(){
  ...
  if(root){
    var cards=[
      ...
      ["Comercio",commerceRequested?commercePlatformLabel(commercePlatform):"Opcional",commerceRequested?commerceStatusLabel(commerceStatus)+" · "+setupShort(commerce.store_url,"sin URL"):"Si vendes online, puedes solicitar Shopify o WooCommerce aquí."]
    ];
