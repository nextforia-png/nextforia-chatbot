...
function logoutCustomerPanel(){clearPanelBrowserState();fetch("/admin/logout",{method:"POST"}).finally(function(){clearPanelBrowserState();location.href="/admin/login";});}
