...
function openSummaryMetric(filter){var summary=document.querySelector("#panel-summary .summary");if(summary&&summary.classList.contains("customizing"))return;setConversationFilter(filter);showTab("conversations");window.scrollTo(0,0);}
