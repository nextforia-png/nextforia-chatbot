...
function whatsappModeActions(rateLimited){return '<button class="primaryBtn" type="button" onclick="connectChannel(&quot;whatsapp&quot;,&quot;coexistence&quot;)">Ya uso WhatsApp Business</button>'+(rateLimited?'<button class="ghostBtn" type="button" disabled>Número nuevo bloqueado temporalmente</button>':'<button class="ghostBtn" type="button" onclick="connectChannel(&quot;whatsapp&quot;,&quot;cloud_api&quot;)">Usar un número nuevo</button>');}
