...
assert(markup.includes('data-rem-moment="before"'));
assert(markup.includes('data-rem-moment="after"'));
assert(markup.includes('id="remAfterPanel"'));
...
assert(clientScript.includes('appointment_services'));
assert(clientScript.includes('Estas reglas aplican a'));
assert(clientScript.includes('/outcome'));
assert(clientScript.includes('saveAppointmentAftercare'));
assert(styles.includes('.remMomentSelector'));
assert(styles.includes('.remAfterPanel'));
