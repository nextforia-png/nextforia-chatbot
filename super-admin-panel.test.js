...
assert.match(html, /id="aiOfficialTotal"/);
assert.match(html, /id="aiPlainSummary"/);
assert.match(html, /id="aiOverallStatus"/);
assert.match(html, /¿Cuánto hemos gastado en inteligencia artificial\?/);
assert.match(html, /Ver saldo \/ recargar/);
...
assert.match(html, /Confirmación de guardado/);
assert.match(html, /Lectura directa del registro central del tenant/);
assert.match(html, /renderAppointmentConfigurationVerification/);
