...
<body>
  <header class="top">
    <nav class="nav" aria-label="Principal">
      <a class="brand" href="/admin/nextfor-appointment-bot"><img src="/admin/assets/nexfor-mark-light.png" alt="">Nextfor Appointment Bot</a>
      <div class="navlinks"><a href="/admin/nextfor-appointment-bot">Producto</a><a href="/admin/privacy">Privacidad</a><a href="/admin/terms">Términos</a></div>
    </nav>
  </header>
  ${content}
...
function renderPrivacyPolicy() {
  return layout(
    ...
    `<main><article class="card">
      ...
      <div class="legal-nav"><a href="/admin/nextfor-appointment-bot">Volver al producto</a><a href="/admin/terms">Condiciones del Servicio</a><a href="mailto:${SUPPORT_EMAIL}">Contactar a Nextfor</a></div>
    </article></main>`
  );
}
...
function renderTermsOfService() {
  return layout(
    ...
    `<main><article class="card">
      ...
      <div class="legal-nav"><a href="/admin/nextfor-appointment-bot">Volver al producto</a><a href="/admin/privacy">Política de Privacidad</a><a href="mailto:${SUPPORT_EMAIL}">Contactar a Nextfor</a></div>
    </article></main>`
  );
}
